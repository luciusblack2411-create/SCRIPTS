...
class CommandId(StrEnum):
    ...
    INTERFACES_SWITCHPORT = "interfaces.switchport"
...
class ParserId(StrEnum):
    ...
    IOS_SHOW_INTERFACES_SWITCHPORT_V1 = "ios.show_interfaces_switchport.v1"
...
class NormalizedModelId(StrEnum):
    ...
    SWITCHPORT_OBSERVATION = "SwitchportObservation"
