...
SWITCHPORT_OBSERVATION_PLAN_V0_1 = AssessmentPlan(
    plan_id="switchport-observation",
    version="0.1",
    commands=(
        AssessmentPlanItem(command_id=CommandId.SYSTEM_VERSION),
        AssessmentPlanItem(command_id=CommandId.INTERFACES_SWITCHPORT),
    ),
)
...
class ProductiveAssessmentPlanId(StrEnum):
    ...
    SWITCHPORT_OBSERVATION = "switchport-observation"
...
_PRODUCTIVE_ASSESSMENT_PLANS: dict[ProductiveAssessmentPlanId, AssessmentPlan] = {
    ...
    ProductiveAssessmentPlanId.SWITCHPORT_OBSERVATION: SWITCHPORT_OBSERVATION_PLAN_V0_1,
